...
const Loader = () => (
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 595.3 594.1">
            <g>
              <g>
                <path fill="#FFFFFF" d="M297.6,380.9c-40.4,0-74.1-28.6-82.1-66.6H81.1c9.5,110.5,102.2,197.2,215.1,197.2 s205.7-86.7,215.1-197.2H379.7C371.7,352.4,338,380.9,297.6,380.9z"/>
                ...
                <path fill="#DF1818" d="M458.3,279.7h55.8c-8.2-95.5-78.6-173.3-170.5-192.6C407.4,120.8,452.9,193.7,458.3,279.7z"/>
              </g>
